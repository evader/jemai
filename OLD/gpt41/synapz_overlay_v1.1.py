# synapz_overlay_v1.1.py
# JEMAI OS Overlay — Version 1.1
# Last Updated: 2025-07-18
# Built by: [AgentName] (pending naming!) for David Lee
"""
Overlay popup for JEMAI OS.
Hotkey: Ctrl+Shift+Space
Supports triggers: SEARCH, CMD, BASE64, ENCODE, NAMEGEN
To update: save as new version, update version in filename and header.
"""
...
class SynapzOverlay(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("JEMAI OS Overlay v1.1")
...
def hotkey_loop():
    print("Hotkey listener active! Press Ctrl+Shift+Space to launch JEMAI OS overlay.")
